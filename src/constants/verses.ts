export const verses = [
  ...
  },
  {
    ...
    name: "Paper Bag Mask",
    youtubeId: "gJEhtCsxQTo",
    verses: [
      {
        performer: "Ruby da Cherry",
        verse: `Im gonna pull
        Im gonna pull the mask off of my face and only my skull will remain
      ...
      {
        performer: "$crim",
        verse: `Back up in the spot with a hole in my skull
  ...
  },
  {
    ...
    album: "Dark Side of the Clouds",
    name: "Cherry P.I.E",
    youtubeId: "7kpV9PPRtyI",
    verses: [
      {
        performer: "Ruby da Cherry",
        verse: `Bitch, I came here to destroy, everything I touch turn grey
        I'm lackin' coin, slit my wrist so I get paid
        Fuck them other boys, I'll slap 'em in they fuckin' face
        ...
        These ho's get wet when I pull out the net
        Leave 'em on deck just to dry
        Then I gut 'em whenever I feel fuckin' hopeless`,
      },
      {
        performer: "$crim",
        verse: `Put a motherfucker face on a white tee
        Ridin' in the Honda when I creep with the G
        ...
        I'm hittin' nirvana and fucking Madonna
  ...
  },
  {
    ...
    album: "Dark Side of the Clouds",
    name: "praisethedevil",
    youtubeId: "-XrHyRl9JAY",
    verses: [
      {
        performer: "Ruby da Cherry",
        verse: `I know motherfuckers wanna be grey
        ...
        Bitch-boy didn't even make the motherfucking list, uh
      ...
      {
        performer: "$crim",
        verse: `Bitches at my burial, tryna touch
  ...
  },
  {
    ...
    album: "Dark Side of the Clouds",
    name: "Jeffer Drive",
    youtubeId: "lR8d4ndXpaI",
    verses: [
      {
        performer: "Ruby da Cherry",
        verse: `Slit my own wrist, bitch, I been killin' shit
      ...
      {
        performer: "$crim",
        verse: `Slumped up off my habits, wit' two full metal jackets
  ...
  },
  {
    ...
    album: "Dark Side of the Clouds",
    name: "Am/Pm",
    youtubeId: "G5Bbnfe4o5s",
    verses: [
      {
        performer: "Ruby da Cherry",
        verse: `I fall asleep, but I don't want to rise out of bed
      ...
      {
        performer: "$crim",
        verse: `Windows down with a frown, ash on my jeans
        Been up eatin' beans
  ...
  },
  {
    artist: "$uicideboy$",
    album: "Dark Side of the Clouds",
    name: "Jon Voight (Live Fast, Die Young)",
    youtubeId: "Nn-XdNr0PdE",
    verses: [
      {
        performer: "Ruby da Cherry",
        verse: `I think I'm kinda dead
        Feelin' like a ghost, half-smoke
        Away I go, I'm Jon Voight
        Ashes fucking shed off the tip of the blunt
        Now I'm sunk from the junk
        Oh no, 'bout to fucking glow
        Fuck a ho, then I melt, I'm made of snow`,
      },
      {
        performer: "$crim",
        verse: `Ridin' uptown with the windows up
        Wake up in the 7th feelin' lost as fuck
        Grab the pills, throw 'em down 'cause I don't give a fuck
        Suicide on my mind, let me test my luck
        Ridin' in the city of the AK's
        (Test my luck, test my luck)
        Bullets with no name and they might spray
        (Test my luck, test my luck)
        Ridin' in the city of the AK's
        (Test my luck, test my luck)
        Bullets with no name and they might spray`,
  ...
  },
  {
    artist: "$uicideboy$",
    album: "Dark Side of the Clouds",
    name: "Marlboros & White Widow (Ft. Germ)",
    youtubeId: "5iOEZOVpEGI",
    verses: [
      {
        performer: "Ruby da Cherry",
        verse: `$uicide, I'm choosing my addictions
        ...
        But I could give a fuck, I stick it in they butt
        Oh, now she wants to be my slut, for what?
        Just 'cause you roll the blunt? Oh no, that ain't how it go, I'm solo
        Frozen ghost, I blow smoke
        Yeah hoe, drop it to the floor—not that ass though
        Talking 'bout your life, I want your body, Oddy leave 'em froze`,
      },
      {
        performer: "$crim",
        verse: `Pop up then I light up, you fucking boys ain't druggin'
        ...
        Don't nothin' make me sicker when I ain't got my fucking fix, bruh
        Satan resurrected, that evil one king of the sixes
        Schizo with depression, PCP laced on my swisher`,
      },
      {
        performer: "GERM",
        verse: `Walk in the pub, drop a stick in her cup
        Drop a stick in her butt, young nigga goin' up
        Savage loads is the code for the hoes, double dose for the load
        Cunt catch it to the dome with the four
        When I ride homicide, $uicide I call it, you gon' die
        Troops in da booths on your stoop
        Banger big like Bruce Bruce, fool, who is you?
        Tell me the truth, bitch, you is not true
        Word to my woes, flow been worth gold
        Hommies and bodies caught riding faded on my Kawasaki
        Asian thottie chuggin' sake, highly likely stuffin' temples with gunmetal
        Reverend rebel speakin' heated conversations
        Hatin' on me? You aint better than me
        The demons in me tweakin' candy, xanny
        Asking for the flurry, I said Fuck you, I cant handle it`,
      },
    ],
  },
  {
    artist: "$uicideboy$",
    album: "Dark Side of the Clouds",
    name: "Golden Calf (Ft. Eddy Baker & Fat Nick)",
    youtubeId: "Rk8Jf5jzZAk",
    verses: [
      {
        performer: "Ruby da Cherry",
        verse: `My money always gone
      ...
      {
        performer: "$crim",
        verse: `Weaponry master, $carecrow in the pasture
      ...
      {
        performer: "Eddy Baker",
        verse: `Little bitch don't trip I'm the shit
      ...
      },
      {
        ...
        Fucked you up, gon' stomp you out in ten thousand dollar outfits`,
      },
    ],
  },
  {
    ...
    verses: [
      ...
      {
        performer: "$crim",
        verse: `One time for the projects
  ...
  },
  {
    artist: "$uicideboy$",
    album: "Dark Side of the Clouds",
    name: "Grayscale (Ft. Black Smurf, JGRXXN & Ramirez)",
    youtubeId: "D6hWIZGyYXc",
    verses: [
      {
        performer: "Ruby da Cherry",
        verse: `Roaches swarm around me as I rise and levitate
      ...
      {
        performer: `JGRXXN`,
        verse: `Watch me hypnotize you niggas 'cause JGRXXN got that phonk
      ...
      {
        performer: "Black Smurf",
        verse: `Hustle the maniac
      ...
      {
        performer: "Ramirez",
        verse: `G-G-G*59 talking to the devil plot another 'nother crime
  ...
  },
  {
    ...
    album: "Dark Side of the Clouds",
    name: "Antarctica",
    youtubeId: "s1-0lt7b-78",
    verses: [
      {
        performer: "Ruby da Cherry",
        verse: `I am the Lord of Loneliness
      ...
      {
        performer: "$crim",
        verse: `Locked in my room, four black walls
  ...
  },
  {
    ...
    youtubeId: "HXI_wss4zkU",
    verses: [
      {
        performer: "Ruby da Cherry",
        verse: `Fuck the police and judges
      ...
      {
        performer: "$crim",
        verse: `Blood stained fabric, cotton up in an addict
        ...
        So we kill, drill, OD poppin' pills
